extends SceneTree
## Livello B, batch 1 (006_PRD/prd-vslice-livello-b-batch-1.md) — Door,
...
## passaggio verso Frontiera delle Porte, e li' raccoglie/combatte/avanza.
...
##
## I 3 ingredienti di formula_door_9 (chiave_senza_denti,
## polvere_di_gesso_stellare, cardine_arrugginito_di_una_porta_perduta)
## sono stati piazzati a terra in data/world/layouts/frontiera_porte.json
## per questo script (PRD, story VS-B1-02): non esistevano in nessun
## layout prima.
##
## Lancio:
##   Xvfb :99 -screen 0 1280x720x24 &
##   DISPLAY=:99 godot --display-driver x11 --rendering-driver opengl3 \
##     --path . --script res://tests/manual/qa_vslice_door.gd

const OUT := "/tmp/qa_vslice_door"
const PID := "door"
