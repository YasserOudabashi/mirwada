extends SceneTree
## Livello B, batch 1 (006_PRD/prd-vslice-livello-b-batch-1.md) — Mother,
...
## passaggio verso Valle della Madre, e li' raccoglie/combatte/avanza.
...
##
## I 3 ingredienti di formula_mother_9 (seme_dormiente,
## terriccio_di_prima_luna, goccia_di_linfa) erano gia' piazzati a terra in
## data/world/layouts/valle_madre.json PRIMA di questo script: zero dati
## nuovi per Mother (verificato nel PRD).
##
## Lancio:
##   Xvfb :99 -screen 0 1280x720x24 &
##   DISPLAY=:99 godot --display-driver x11 --rendering-driver opengl3 \
##     --path . --script res://tests/manual/qa_vslice_mother.gd

const OUT := "/tmp/qa_vslice_mother"
const PID := "mother"
