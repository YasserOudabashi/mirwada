...
## talenti_innati (US-332): id di talenti tipo:innato, quanti balance.json.
## talenti.innati_da_scegliere ne chiede - la pagina li sceglie, qui si
## concedono e basta.
